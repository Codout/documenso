  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        // Codout fork: re-aliased to the Codout indigo scale so that the
        // dozens of `bg-documenso-*` / `text-documenso-*` utility usages
        // adopt the Codout brand without a class-name rename. The palette
        // key stays `documenso` to keep upstream merges trivial.
        documenso: {
          DEFAULT: '#4F46E5',
          50: '#EEF2FF',
          100: '#E0E7FF',
